...
const f1 = () => {
    a1_res = a1.flat();
    document.querySelector('.out-1').innerHTML = a1_res.reduce((res, cur) => res += cur + ' ', '');
}
...
const f2 = () => {
    a2_res = a2.flat();
    document.querySelector('.out-2').innerHTML = a2_res.reduce((res, cur) => res += cur + ' ', '');
}
...
const f3 = () => {
    a3_res = a3.flat(2);
    document.querySelector('.out-3').innerHTML = a3_res.reduce((res, cur) => res += cur + ' ', '');
}
...
const f4 = () => {
    a4.fill(7, 2, 5);
    document.querySelector('.out-4').innerHTML = a4.reduce((res, cur) => res += cur + ' ', '');
}
...
const f5 = () => {
    a5.fill(0, 2);
    document.querySelector('.out-5').innerHTML = a5.reduce((res, cur) => res += cur + ' ', '');
}
...
const f7 = (l) => {
    let res = [];
    for(let i = 0; i < l; i++){
        res.push(Math.floor(Math.random() * ((100 + 1) - 0) + 0));
    }
    return res;
}
...
const f8 = () => {
    ...
    document.querySelector('.out-8').innerHTML = a8_res.reduce((res, cur) => res += cur + ' ', '');
}
...
const f9 = () => {
    ...
    document.querySelector('.out-9').innerHTML = a9_res.reduce((res, cur) => res += cur + ' ', '');
}
...
const f10 = () => {
    ...
    document.querySelector('.out-10').innerHTML = a10_res.reduce((res, cur) => res += cur + ' ', '');
}
