...
const f1 = () => {
    ...
    document.querySelector('.out-1').innerHTML = a1.indexOf(value);
}
...
const f2 = () => {
    ...
    document.querySelector('.out-2').innerHTML = a2.indexOf(val) >= 0 ? a2.indexOf(val) : false;;
}
...
const f3 = () => {
    ...
    document.querySelector('.out-3').innerHTML = a3.indexOf(val) >= 0;
}
