...
const f4 = () => {
    z4 = a4.filter(e => typeof(e) != 'number');
    console.log(z4);
}
...
const f6 = () => {
    z6 = a6.filter(e => e.reduce((r, i) => r + i, 0) % 2 == 0);
    console.log(z6);
}
...
const f7 = () => {
    z7 = a7.filter(e => e.pass.length <= 6);
    console.log(z7);
}
