...
const f1 = () => {
    ...
    document.querySelector('.out-1').innerHTML = a1_res.reduce((acc, item) => acc + item + ' ', '');
}
...
const f4 = () => {
    ...
    document.querySelector('.out-4').innerHTML = a4_res.reduce((acc, item) => acc + item + ' ', '');
}
...
const f6 = (...args) => {
    let res = args.reduce((acc, item) => {
        item.forEach(e => acc.push(e));
        return acc;
    }, []);
    return res;
}
...
const f7 = () => {
    a7.splice(2, 3);
    document.querySelector('.out-7').innerHTML = a7.reduce((acc, item) => acc + item + ' ', '');
}
...
const f8 = () => {
    a8.splice(k8, n8);
    let res = a8.reduce((acc, item) => acc + item + ' ', '');
...
const f9 = () => {
    a9.splice(0, 3, 7, 9);
    let res = a9.reduce((acc, item) => acc + item + ' ', '');
